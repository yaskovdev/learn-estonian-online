...
* Selle_l_ mehe_l_ on hea naine. (У кого?) -> У этого мужчины (есть кто?) -> хорошая жена.
* Mina räägin oma huvitavaST tööST. Я расскажу (о чем?) -> о своей интересной работе.
* Meie sõidame Kohtla-Järve_le_, Tapa_le_ ja Jägeva_le_. Мы едем (куда?-> в Кохтла-Ярве, в Тапа и в Йыгева.
